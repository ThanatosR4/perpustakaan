        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row mb-3">
                        <div class="col-md-4 text-center">
                            ...
                            <div class="photo-container-3x4">
                                <img src="{{ asset('storage/' . $item->foto) }}" alt="Foto Profil" class="img-fluid rounded">
                            </div>
                        </div>
                    ...
                    <form action="{{ route('siswa.resetPassword', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mereset password siswa ini ke password default?')">
                        @csrf
